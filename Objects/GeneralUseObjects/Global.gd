...
var messages = { 0 : "EXODUS preparation complete",
				...
				2 : "Warning: creatures escaped portal",
				3 : "Water as power source implemented",
				4 : "Do not terminate the creatures",
				5 : "Creatures helping kill intruders",
				...
				15 : "All personal: keep flashlight on",
				16 : "Mission objective: find new home",
				17 : "New planet found: start EXODUS",
				18 : "EXODUS list at maximum capacity",
